...
/* Maps screen → which tab should be highlighted */
    ...
    <nav className="flex justify-around items-end px-2 pt-2 pb-4 bg-white/95 backdrop-blur-lg border-t border-line">
      {TAB_ITEMS.map(tab => tab.fab ? (
        <button
          ...
          className="-mt-7 w-14 h-14 rounded-[22px] brand-gradient grid place-items-center text-white text-3xl font-black shadow-cta active:scale-95 transition-transform"
